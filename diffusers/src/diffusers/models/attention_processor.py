...
class Attention(nn.Module):
    ...
    def forward(
        ...
        **cross_attention_kwargs,
        ...
        if hasattr(self.processor, "forward"):
            adapter_attn_parameters = set(inspect.signature(self.processor.forward).parameters.keys())
            attn_parameters.update(adapter_attn_parameters)
