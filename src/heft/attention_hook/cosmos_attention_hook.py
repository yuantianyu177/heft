...
class CosmosProcessorAdapter(nn.Module):
    def __init__(
        self, 
        **kwargs
    ):
        ...
        if not hasattr(F, "scaled_dot_product_attention"):
            raise ImportError("CosmosProcessorAdapter requires PyTorch 2.0. To use it, please upgrade PyTorch to 2.0.")
...
class CosmosAttentionHook(AttentionHook):
    def __init__(self, **kwargs):
        self.adapter_name = "CosmosProcessorAdapter"
